...
.post(isLoggedIn,upload.single("list[url]"), wrapasync( listingcontroller.getlisting))
...
router.route("/:id")
  ...
  .put(isLoggedIn,isOwner,isLoggedIn,upload.single("list[url]"),wrapasync(listingcontroller.putedit));
